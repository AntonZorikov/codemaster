...
//        }
    ...
    public ResponseEntity<Resource> downloadArchive(@RequestParam("fileName") String fileName) throws MalformedURLException {
        try {
            fileName = fileName + ".rar";
            Path filePath = Paths.get(uploadDirectoryArchive, fileName);
